...
app.use('/api/v2/inventory', supplierRoutes);  // Keep suppliers at base /api/v2/inventory
app.use('/api/v2/inventory', purchaseOrderRoutes);  // Purchase orders also at /api/v2/inventory
